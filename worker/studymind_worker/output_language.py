...
OUTPUT_LANGUAGE_SEMANTICS: Final[dict[OutputLanguage, OutputLanguageSemantics]] = {
    "zh-CN": OutputLanguageSemantics(
        ...
        default_suitable_use="学习应用",
        insights_title="学习问题",
        insight_item_label="学习问题",
        insight_topic_heading="学习问题",
        match_reason_heading="匹配理由",
        follow_up_heading="复习与练习问题",
        suitable_use_heading="学习用途",
        ...
        question_example_reason="这道学习问题与文字稿和学习偏好相符。",
        question_example_follow_up="团队应该先改造哪条流程？",
        question_example_use="学习用途",
    ...
    "zh-TW": OutputLanguageSemantics(
        ...
        default_suitable_use="學習應用",
        insights_title="學習問題",
        insight_item_label="學習問題",
        insight_topic_heading="學習問題",
        match_reason_heading="匹配理由",
        follow_up_heading="複習與練習問題",
        suitable_use_heading="學習用途",
        ...
        question_example_reason="這道學習問題符合逐字稿與學習偏好。",
        question_example_follow_up="團隊應該先改造哪一條流程？",
        question_example_use="學習用途",
    ...
    "en-US": OutputLanguageSemantics(
        ...
        summary_title="Knowledge Structure",
        ...
        default_suitable_use="Study application",
        insights_title="Study Questions",
        insight_item_label="Study Question",
        insight_topic_heading="Study Question",
        ...
        question_example_reason="This study question matches the transcript and selected learning preferences.",
        question_example_follow_up="Which workflow should the team improve first?",
        question_example_use="Study use",
