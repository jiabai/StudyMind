...
const strings: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "admin.activation_desc": "兑换后获得 31 天月卡权益 + 100 LLM Credits。",
  ...
  "zh-TW": {
    ...
    "admin.activation_desc": "兌換後取得 31 天月卡權益 + 100 LLM Credits。",
  ...
  en: {
    ...
    "admin.activation_desc": "Redeem for 31-day monthly entitlement + 100 LLM Credits.",
