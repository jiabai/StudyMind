...
export class PrismaStore implements Store {
  ...
  issueEmailOtp(input: Parameters<Store["issueEmailOtp"]>[0]): ReturnType<Store["issueEmailOtp"]> { return auth.issueEmailOtp(this.prisma, input); }
  ...
  verifyDesktopOtpAndCreateTicket(input: Parameters<Store["verifyDesktopOtpAndCreateTicket"]>[0]): ReturnType<Store["verifyDesktopOtpAndCreateTicket"]> { return auth.verifyDesktopOtpAndCreateTicket(this.prisma, input); }
  verifyDesktopOtpAndCreateTicketAndWebSession(input: Parameters<Store["verifyDesktopOtpAndCreateTicketAndWebSession"]>[0]): ReturnType<Store["verifyDesktopOtpAndCreateTicketAndWebSession"]> { return web.verifyDesktopOtpAndCreateTicketAndWebSession(this.prisma, input); }
  verifyAdminOtpAndCreateSession(input: Parameters<Store["verifyAdminOtpAndCreateSession"]>[0]): ReturnType<Store["verifyAdminOtpAndCreateSession"]> { return auth.verifyAdminOtpAndCreateSession(this.prisma, input); }
  verifyUserOtpAndCreateWebSession(input: Parameters<Store["verifyUserOtpAndCreateWebSession"]>[0]): ReturnType<Store["verifyUserOtpAndCreateWebSession"]> { return web.verifyUserOtpAndCreateWebSession(this.prisma, input); }
  exchangeDesktopTicketAndCreateSession(input: Parameters<Store["exchangeDesktopTicketAndCreateSession"]>[0]): ReturnType<Store["exchangeDesktopTicketAndCreateSession"]> { return auth.exchangeDesktopTicketAndCreateSession(this.prisma, input); }
  ...
  settlePaidOrder(input: Parameters<Store["settlePaidOrder"]>[0]): ReturnType<Store["settlePaidOrder"]> { return billing.settlePaidOrder(this.prisma, input); }
  ...
  consumeLlmQuota(userId: string, requestId: string, now: Date): ReturnType<Store["consumeLlmQuota"]> { return entitlements.consumeLlmQuota(this.prisma, userId, requestId, now); }
  ...
  redeemActivationCodeAndGrantEntitlement(input: Parameters<Store["redeemActivationCodeAndGrantEntitlement"]>[0]): ReturnType<Store["redeemActivationCodeAndGrantEntitlement"]> { return entitlements.redeemActivationCodeAndGrantEntitlement(this.prisma, input); }
  ...
  applyEntitlementAdjustmentWithAudit(input: Parameters<Store["applyEntitlementAdjustmentWithAudit"]>[0]): ReturnType<Store["applyEntitlementAdjustmentWithAudit"]> { return entitlements.applyEntitlementAdjustmentWithAudit(this.prisma, input); }
